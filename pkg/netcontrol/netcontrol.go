...
func (netWatcher *NetWatcher) AddNad(obj interface{}) {
  ...
  if dnet.Spec.Options.Vlan != 0 ||dnet.Spec.Options.Vxlan != 0 {
    ...
    _, err = netWatcher.NadClient.K8sCniCncfIoV1().NetworkAttachmentDefinitions("").Update(context.TODO(), nad, meta_v1.UpdateOptions{})
    if err != nil {
...
func (netWatcher *NetWatcher) UpdateNad(oldObj, newObj interface{}) {
  ...
  if parentUpdateNeeded {
    ...
    _, err = netWatcher.NadClient.K8sCniCncfIoV1().NetworkAttachmentDefinitions("").Update(context.TODO(), newNad, meta_v1.UpdateOptions{})
    if err != nil {
